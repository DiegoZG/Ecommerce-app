const products = [
  ...
  {
    name: 'Cannon EOS R6 Camera',
    image: '/images/camera.jpg',
    description:
      'Characterized by versatile imaging specs, the Canon EOS R6 further clarifies itself using a pair of robust focusing systems and an intuitive design',
    brand: 'Cannon',
    category: 'Electronics',
    price: 1299.99,
    countInStock: 5,
  ...
  {
    name: 'Logitech G-502 Gaming Mouse',
